...
?>
      <h1>HK公司採購系統</h1>
    <form name="purchase" method="post" action="purchase.php">
      <table border="1">
        <tr><td>產品類別：</td><td><input type="text" name="kind" size="10"></td><tr>
        <tr><td>產品編號：</td><td><input type="text" name="prno" size="10"></td><tr>
        <tr><td>產品名稱：</td><td><input type="text" name="prna" size="10"></td><tr>
        <tr><td>圖檔名稱：</td><td><input type="text" name="photona" size="15"></td><tr>
