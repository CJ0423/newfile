...
<?php        ///// 以 get 的方式傳送 帳號 ?表示get  ///////
                    echo '<a href="toy.php?idname='.$idname.'" target="main">玩具商城</a><br>';
                    echo '<a href="purses.php?idname='.$idname.'" target="main">皮包天地</a><br>';
?>
                               服飾百貨<br>
               </font>
              </td>
              <td>
                 <iframe name="main" src="toy.php" width="100%" height="100%"></iframe>
              </td>
              <td width="300">
