...
(001, 'toy', 'toy01', '紳士鳥', 'bank-1.wmf', 200, '陶瓷', 300, 100),
...
(005, 'toy', 'toy05', '花花豬', 'bank-56.wmf', 180, '陶瓷', 300, 100),
...
(009, 'toy', 'toy09', '聖誕老人', 'bank-164.wmf', 250, '陶瓷', 300, 100),
(010, 'toy', 'toy10', '小飛象', 'bank-176.wmf', 130, '橡膠', 300, 100),
(011, 'purses', 'purses01', '棋盤勇士', '01.jpg', 3730, 'polo', 300, 100),
(012, 'purses', 'purses02', '經典綠格', '02.jpg', 660, 'polo', 300, 100),
...
--
ALTER TABLE `product`
MODIFY `idno` tinyint(3) unsigned zerofill NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
